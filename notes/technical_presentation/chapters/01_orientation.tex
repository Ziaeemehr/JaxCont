...
``+'' means the published v0.3.1 release plus current-main features intended
for v0.4.\par
...
\vfill
\centering
\textcolor{JaxTeal}{Chapter 12 remains available as the scope-and-glossary reference.}
\end{frame}
